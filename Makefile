...
run-pir:
    ...
    ansible-playbook ./playbooks/deploy-clab-topology.yml --extra-vars "topology_path=/home/anton/git_hub/ansible-juniper-lab-jncis-sp/clab/pir_topology.yml"; \
    ...
    ansible-playbook ./playbooks/render-pir-base.yml -i ./inventory/pir_inventory.yml; \
    echo "Running playbook to configure nodes"; \
    ansible-playbook ./playbooks/conf-files.yml -i ./inventory/pir_inventory.yml; \
    echo -e "Lab setup complete with basic configuration:\nR1-10.0.0.1/24\nR2-10.0.0.2/24 and 10.0.1.2/24\nR3-10.0.1.3/24"
